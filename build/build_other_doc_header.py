...
documentTemplateName = 'index.md' # This is the input file into which the header metadata will be inserted.
outFileName = '../docs/' + document_slug + '/index.md' # This is where the document rendered by GitHub Pages will be created.

config_file_path = 'process/document_metadata_processing/dwc_doc_' + document_slug + '/'
