...
if '--dir' in opts:
    ...
    print('For example, if the path to the templates in the rs.tdwg.org repo')
    print('is "process/document_metadata_processing/dwc_doc_eco/", the directory name is "dwc_doc_eco".')
    exit()
